...
//BUSDEV_REGISTER_SPI_TAG(busdev_imu0,    DEVHW_MPU6500,  MPU6500_0_SPI_BUS,  MPU6500_0_CS_PIN,  NONE,     0,  DEVFLAGS_NONE,  IMU_0_ALIGN);
...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM4, CH1, PB6, TIM_USE_OUTPUT_AUTO, 0, 0), // used to be fw motor
    DEF_TIM(TIM4, CH2, PB7, TIM_USE_OUTPUT_AUTO, 0, 0), // used to be fw motor
